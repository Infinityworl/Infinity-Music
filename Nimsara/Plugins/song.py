...
"""
    ...
    try:
        ...
        await context.bot.send_audio(chat_id=message.chat_id, audio=song,thumbnail=thumbloc, caption=caption_text.format(title, duration, performer,f"https://youtu.be/{vid_id}", views,user), reply_to_message_id=message.message_id, parse_mode='Markdown')
