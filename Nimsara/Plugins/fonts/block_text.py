async def block_text(text):
    ...
    try:
        ...
        text = text.replace('1', '𝟷') 
        text = text.replace('2', '𝟸') 
        text = text.replace('3', '𝟹') 
        text = text.replace('4', '𝟺') 
        text = text.replace('5', '𝟻') 
        text = text.replace('6', '𝟼') 
        text = text.replace('7', '𝟽') 
        text = text.replace('8', '𝟾') 
        text = text.replace('9', '𝟿') 
        text = text.replace('0', '𝟶') 
        return text
    except:
        return text
